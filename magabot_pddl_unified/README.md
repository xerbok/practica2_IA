...
- `(unordered-mode)` per als problemes sense restricció d'ordre
- `(ordered-mode)` per als problemes amb ordre obligatori
...
Només es poden dispensar paquets marcats amb `(required ...)`, tal com demana l'enunciat.
